    ...
    return(
        ...
        <div  className='md:flex md:gap-[65px] md:ml-[60px] ml-[50px]'>
          ...
          <Image className='mx-[100px]' src='/images/icons/GrayHeart.PNG' alt="Heart" width={25} height={25} />
            ...
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/car.png" alt="Catalog" width={275} height={100}/></Link>
          ...
          <p className='w-[304px] h-[388px]'>
            ...
            <span className='text-[#90A3BF]'>Sport</span>
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/Car1.png" alt="Catalog" width={275} height={100}/></Link>
            <span className='flex  gap-2 mt-[50px]'>
            <Image  src="/images/icons/Liter.PNG" alt="Catalog" width={35} height={35}/>
            <label className='leading-[40px] text-[#90A3BF]'>80L</label>
            <Image  src="/images/icons/Manual.PNG" alt="Catalog" width={35} height={35}/>
...
<p className='w-[304px] h-[388px]'>
            ...
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/CarCat2/Car1.png" alt="Catalog" width={275} height={100}/></Link>
            <span className='flex  gap-2 mt-[50px]'>
            <Image  src="/images/icons/Liter.PNG" alt="Catalog" width={35} height={35}/>
          ...
          <p className='w-[304px] h-[388px]'>
            ...
            <span className='text-[#90A3BF]'>SUV</span>
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/CarCat2/Car2.png" alt="Catalog" width={275} height={100}/></Link>
            <span className='flex  gap-2 mt-[50px]'>
            <Image  src="/images/icons/Liter.PNG" alt="Catalog" width={35} height={35}/>
            <label className='leading-[40px] text-[#90A3BF]'>80L</label>
            <Image  src="/images/icons/Manual.PNG" alt="Catalog" width={35} height={35}/>
          ...
          <p className='w-[304px] h-[388px]'>
            ...
            <span className='text-[#90A3BF]'>SUV</span>
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/CarCat2/Car3.png" alt="Catalog" width={275} height={100}/></Link>
            <span className='flex  gap-2 mt-[50px]'>
            <Image  src="/images/icons/Liter.PNG" alt="Catalog" width={35} height={35}/>
          ...
          <p className='w-[304px] h-[388px]'>
            ...
            <span className='text-[#90A3BF]'>Sport</span>
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/CarCat2/Car4.png" alt="Catalog" width={275} height={100}/></Link>
            <span className='flex  gap-2 mt-[50px]'>
            <Image  src="/images/icons/Liter.PNG" alt="Catalog" width={35} height={35}/>
            <label className='leading-[40px] text-[#90A3BF]'>80L</label>
            <Image  src="/images/icons/Manual.PNG" alt="Catalog" width={35} height={35}/>
        ...
        <p className='w-[304px] h-[388px]'>
            ...
            <Link href="./Category">
            <Image className='mt-[60px]' src="/images/CarCat1/CarCat3/Car1.png" alt="Catalog" width={275} height={100}/></Link>
            <span className='flex  gap-2 mt-[50px]'>
            <Image  src="/images/icons/Liter.PNG" alt="Catalog" width={35} height={35}/>
            <label className='leading-[40px] text-[#90A3BF]'>70L</label>
            <Image  src="/images/icons/Manual.PNG" alt="Catalog" width={35} height={35}/>
